...
%% Courtesy: Daniel Spielman, via Madhu Sudan.
...
%    \framebox{
%       \vbox{
%     \hbox to 5.78in { {\bf 0368.4162 Foundations of Cryptography}
%      	 \hfill #2 }
%        \vspace{4mm}
...
% \newcommand{\lecture}[4]{\handout{#1}{#2}{}{Due: #4}{Problem Set #1}}
...
\ifscribes
\newcommand{\scribes}[1]{{\color{red} Scribes: { #1}.}}
\else
\newcommand{\scribes}[1]{}
\fi
